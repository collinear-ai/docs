...
- `API-Key: <COLLINEAR_API_KEY>` – use the Collinear API key from your dashboard (the same key you configure in the SDK / TauTrait runtime).
...
- To validate trait names up front, call [List Supported Traits](/api-reference/endpoint/helpers).
