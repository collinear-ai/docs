...
Use this endpoint to create or append datasets that appear under **Datasets** in
the platform. It accepts JSON/CSV files and is the standard ingestion method
outside the Assess pipeline.
...
The current deployment streams the uploaded rows back in the body instead of the
