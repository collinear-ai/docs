...
<iframe src="https://demo.arcade.software/QaJTUpdCpo5HgdHqiSTy?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true" title="Effortlessly Evaluate AI Models with Collinear" frameborder="0" loading="lazy" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="clipboard-write" style='{ position:"absolute",top:0,left:0,width:"100%",height:"100%",colorScheme:"light" }' />
