...
<iframe src="https://demo.arcade.software/TX0DnnEm2mDVMFGke1XN?embed&embed_mobile=inline&embed_desktop=inline&show_copy_link=true" title="Explore AI Model Evaluation with Collinear AI" frameborder="0" loading="lazy" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="clipboard-write" style={{ position:"absolute",top:0,left:0,width:"100%",height:"100%",colorScheme:"light" }} />
