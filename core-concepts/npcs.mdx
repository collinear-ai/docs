...
NPCs (non-player characters) are simulated users that populate the environment and interact with or are referenced by tasks. Each NPC has defined interests and personality traits that influence how they behave in the simulation.
