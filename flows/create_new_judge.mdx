...
**Hallucination Judges** focus on detecting factual inaccuracies in generated responses. Language models sometimes produce information that appears plausible but is incorrect or fabricated—this phenomenon is known as "hallucination."

### Use Cases for Hallucination Judges
...
<img
    style={{borderRadius: '0.5rem'}}
    src='https://webresources-s3.s3.amazonaws.com/flows/create_judge/creating_judge_flow_1.png'
/>
---
<a href={'/flows/create_safety_judge'}>
    Here is additional information on creating a Safety Judge.
</a>
