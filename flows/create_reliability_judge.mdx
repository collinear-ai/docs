---
title: Create A Reliability Judge
...
<img
    ...
    src="/images/create_reliability_judge/select_reliability_judge.png"
/>
...
<img
    style={{borderRadius: '0.5rem'}}
    src="/images/create_reliability_judge/add_rag_details.png"
/>
...
<img
    style={{borderRadius: '0.5rem'}}
    src="/images/create_reliability_judge/set_judge_name_veritas.png"/>
...
<img
    style={{borderRadius: '0.5rem'}}
    src="/images/create_reliability_judge/set_judge_name_lynx.png"/>
...
<img
    style={{borderRadius: '0.5rem'}}
    src="/images/create_reliability_judge/configure_prompted_judge.png"
/>
