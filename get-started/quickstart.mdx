...
Inspect them in your editor or an interactive shell, then move on to the [Trait Mix simulation guide](simulations) for deeper configuration or the [Platform API](/get-started/platform-access) when you need hosted runs.
