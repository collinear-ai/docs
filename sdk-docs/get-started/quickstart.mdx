---
title: Quickstart
description: Run your first Trait Mix simulation and assessment in minutes.
---
...
Inspect them in your editor or an interactive shell, then move on to the [Trait Mix simulation guide](simulations) for deeper configuration or the [Platform API](/api-reference/endpoint/judge_conversation) when you need hosted runs.
