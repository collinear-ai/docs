...
No data leaves your environment beyond the models you call.
...
result = client.assess(
    ...
    judge_model_api_key=os.getenv("JUDGE_API_KEY", os.environ["OPENAI_API_KEY"]),
...
Ensure `simulations` is a non-empty list of `SimulationResult` objects returned from `client.simulate`.
