...
- Script persona-driven simulations directly against an OpenAI-compatible model endpoint.
- Generate synthetic conversations for evaluation, RL fine-tuning, or data analysis without touching the dashboard.
...
export STEER_API_KEY=demo-001  # Replace with your issued key when available
```
...
steer_config = {
    ...
    "traits": {"impatience": [0, 3]},
}

simulations = client.simulate(steer_config, k=1, num_exchanges=2)
