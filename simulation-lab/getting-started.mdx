...
The `collinear-sim-lab` CLI is the primary interface. It handles scenario composition, task management, agent execution, and teardown.
...
## Step 1 — Start a Local Playground

Initialize a playground from a template (or pick tools interactively), build it, and start it:
